...
[Expands](../features/viewport) the Web App.
...
Updates the [Main Button](../features/main-button) settings.
...
Updates current [closing behavior](../features/closing-behavior).
...
Updates the [Back Button](../features/back-button) settings.
...
Updates the Web App [header color](../features/theme#background-and-header-colors).
...
Generates the [haptic feedback](../features/haptic-feedback) event.
...
Opens a new [popup](../features/popup). When user closes the popup, Telegram
